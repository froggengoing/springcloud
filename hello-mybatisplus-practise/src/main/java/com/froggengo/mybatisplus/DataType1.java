...
public class DataType1 {
    ...
    static {
        ...
        dataType.defaultPrecision = dataType.maxPrecision = 1/* ValueNull.PRECISION */;
        ...
        add(Value.BYTE, Types.TINYINT,
            createNumeric(3/*ValueByte.PRECISION*/, 0, false),
            new String[]{"TINYINT"}
        );
        add(Value.SHORT, Types.SMALLINT,
            createNumeric(3/*ValueShort.PRECISION*/, 0, false),
        ...
        add(Value.FLOAT, Types.REAL,
            createNumeric(3/*ValueFloat.PRECISION*/, 0, false),
        ...
        add(Value.TIME, Types.TIME,
            createDate(ValueTime.MAXIMUM_PRECISION, ValueTime.DEFAULT_PRECISION,
                       "TIME", true, 0/* ValueTime.DEFAULT_SCALE */, ValueTime.MAXIMUM_SCALE),
        ...
        add(Value.TIME_TZ, 2013,
            createDate(ValueTimeTimeZone.MAXIMUM_PRECISION, ValueTimeTimeZone.DEFAULT_PRECISION,
                       "TIME WITH TIME ZONE", true, 0/* ValueTime.DEFAULT_SCALE */,
        ...
        add(Value.TIMESTAMP, Types.TIMESTAMP,
            createDate(ValueTimestamp.MAXIMUM_PRECISION, ValueTimestamp.DEFAULT_PRECISION,
                       "TIMESTAMP", true, 6/* ValueTimestamp.DEFAULT_SCALE */, ValueTimestamp.MAXIMUM_SCALE),
        ...
        add(Value.TIMESTAMP_TZ, 2014,
            createDate(ValueTimestampTimeZone.MAXIMUM_PRECISION, ValueTimestampTimeZone.DEFAULT_PRECISION,
                       "TIMESTAMP WITH TIME ZONE", true, 6/* ValueTimestamp.DEFAULT_SCALE */,
        ...
        dataType.defaultPrecision = dataType.maxPrecision = 16/* ValueUuid.PRECISION */;
    ...
    private static void addDecimal() {
        add(Value.DECIMAL, Types.DECIMAL,
            createNumeric(Integer.MAX_VALUE, 65535/* ValueDecimal.DEFAULT_PRECISION */,
                          32767/* ValueDecimal.DEFAULT_SCALE */),
    ...
    private static void addInterval(int type) {
        ...
        if (qualifier.hasSeconds()) {
            ...
            dataType.defaultScale  = 6/* ValueInterval.DEFAULT_SCALE */;
        ...
        switch (v.getValueType()) {
            case Value.JAVA_OBJECT: {
                Object o = SysProperties.serializeJavaObject ? JdbcUtils.deserialize(v.getBytes(),
                                                                                     conn.getSession().getDataHandler())
                    : v.getObject();
